...
async def main():
    _user_id = os.getenv('USER_ID')  # Now using an environment variable
    # Load proxies from a file specified in an environment variable
    proxies_file_path = os.getenv('PROXIES_FILE_PATH', 'proxy_list.txt')
